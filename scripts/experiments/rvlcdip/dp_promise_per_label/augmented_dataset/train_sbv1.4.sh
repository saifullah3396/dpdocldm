...
MODEL_CHECKPOINT=output/atria_trainer/IitCdip/iitcdip_aug_pretraining_sbv1.4/checkpoints/checkpoint_1279790.pt
...
for LABEL in {0..15}; do
    PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=rvlcdip TASK_MODULE=sbv1.4_uncond \
        ...
        image_size=256 \
        experiment_name=rvlcdip_dp_promise_aug_sbv1.4_cfg_per_label \
