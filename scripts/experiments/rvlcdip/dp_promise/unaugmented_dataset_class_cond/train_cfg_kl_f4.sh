...
MODEL_CHECKPOINT=output/atria_trainer/IitCdip/iitcdip_unaug_class_cond_pretraining_klf4/checkpoints/checkpoint_319950.pt
...
PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=rvlcdip TASK_MODULE=klf4_classifier_guidance \
    ...
    image_size=256 \
    experiment_name=rvlcdip_dp_promise_unaug_class_cond_klf4_cfg_bs_4096 \
    ...
    private_training_engine.noise_multiplier=0.72 \
    private_batch_size=4096