...
PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=rvlcdip_with_ocr TASK_MODULE=klf4_classifier_guidance_and_layout_cond \
    ...
    image_size=256 \
    experiment_name=rvlcdip_dp_promise_unaug_layout_cond_klf4_cfg_bs_4096 \
