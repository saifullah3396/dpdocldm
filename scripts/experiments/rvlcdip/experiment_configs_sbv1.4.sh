...
CONFIGS=(
    ...
    "${SCRIPT_DIR}/dp/unaugmented_dataset_class_cond/train_cfg_sbv1.4.sh"
    # "${SCRIPT_DIR}/dp_promise/augmented_dataset/train_cfg_sbv1.4.sh"
    # "${SCRIPT_DIR}/dp_promise/unaugmented_dataset/train_cfg_sbv1.4.sh"
    "${SCRIPT_DIR}/dp_promise/unaugmented_dataset_class_cond/train_cfg_sbv1.4.sh"
    ...
    "${SCRIPT_DIR}/dp_per_label/unaugmented_dataset_class_cond/train_sbv1.4.sh"
    ...
    "${SCRIPT_DIR}/dp_promise_per_label/unaugmented_dataset_class_cond/train_sbv1.4.sh"
)
