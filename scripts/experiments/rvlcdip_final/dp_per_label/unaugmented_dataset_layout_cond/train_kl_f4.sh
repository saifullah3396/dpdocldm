...
LABEL=$1
TARGET_EPSILON=$2
PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=rvlcdip_with_ocr TASK_MODULE=klf4_layout_cond \
    ...
    image_size=256 \
    experiment_name=rvlcdip_final_dp_unaug_layout_cond_klf4_cfg_per_label_eps_$TARGET_EPSILON \
