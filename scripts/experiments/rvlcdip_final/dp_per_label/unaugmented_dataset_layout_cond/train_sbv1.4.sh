...
LABEL=$1
TARGET_EPSILON=$2
PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=rvlcdip_with_ocr TASK_MODULE=sbv1.4_layout_cond \
    ...
    image_size=256 \
    experiment_name=rvlcdip_final_dp_unaug_layout_cond_sbv1.4_cfg_per_label_eps_$TARGET_EPSILON \
    features_key=stable-diffusion-v1-4-layout \
    data_module.subset_label=$LABEL \
    data_module.max_test_samples=10000 \
    max_physical_batch_size=32 \
    visualization_engine.visualize_on_start=False \
