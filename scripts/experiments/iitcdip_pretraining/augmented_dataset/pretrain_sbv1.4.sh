...
PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=iitcdip_aug TASK_MODULE=sbv1.4_uncond python $BASE_DIR/external/atria/src/atria/core/task_runners/atria_trainer.py \
    ...
    experiment_name=iitcdip_aug_pretraining_sbv1.4 \
    features_key=stable-diffusion-v1-4-aug \
