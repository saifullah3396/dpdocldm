...
PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=iitcdip_aug TASK_MODULE=klf4_uncond python $BASE_DIR/external/atria/src/atria/core/task_runners/atria_trainer.py \
    ...
    image_size=256 \
    experiment_name=iitcdip_aug_pretraining_klf4 \
    features_key=kl-f4-aug-0.4 \
