...
PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=iitcdip TASK_MODULE=sbv1.4_cfg python $BASE_DIR/external/atria/src/atria/core/task_runners/atria_trainer.py \
    ...
    image_size=256 \
    experiment_name=iitcdip_unaug_class_cond_pretraining_sbv1.4 \
