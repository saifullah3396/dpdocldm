...
# PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=iitcdip_with_ocr TASK_MODULE=sbv1.4_cfg_and_layout_cond python $BASE_DIR/external/atria/src/atria/core/task_runners/atria_trainer.py \
...
#     image_size=256 \
#     experiment_name=iitcdip_unaug_layout_cond_pretraining_sbv1.4 \
