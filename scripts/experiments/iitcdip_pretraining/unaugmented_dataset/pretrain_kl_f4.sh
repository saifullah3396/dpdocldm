...
# PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=iitcdip TASK_MODULE=klf4_uncond python $BASE_DIR/external/atria/src/atria/core/task_runners/atria_trainer.py \
...
#     experiment_name=iitcdip_unaug_pretraining_klf4 \
#     features_key=klf4 \
#     do_train=False \
#     do_test=False
